...
import { validateLimitText } from "src/mf_shared_components/services/helper.service";
import { DestroyObs } from "src/mf_shared_components/abstract-classes/destroy.abstract";
  ...
  implements OnInit, OnChanges, ControlValueAccessor
{
  ...
  public get touched() {
    return this.ngControl?.touched && this.ngControl?.touched;
  }
